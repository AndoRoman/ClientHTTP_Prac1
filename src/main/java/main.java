...
public class main {
    ...
    public static int LineCount(Document Input) {
        try {
            return Input.html().split(System.getProperty("Line.separator")).length;
        }catch (Exception e){
            return 0;
        }
    }
    ...
    public static int paraCount(Document Input) {
        int num = 0;
        String[] filter = Input.html().split("<p>");
        num = (filter.length)/2;
        return num;
    }
    //Function to Count <img> on Document
    public static int imgCount(Document Input) {
        int num = 0;
    ...
    public static void main (String[] args) throws IOException {
       ...
       // System.out.println("El Documento tiene: "+LineCount(docHTML)+" Lineas de codigo.");
        ...
        //Print Num of <img>
        System.out.println("El Documento tiene: "+ " Imagenes");
    }
